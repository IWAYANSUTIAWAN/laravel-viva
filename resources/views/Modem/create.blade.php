...
@endsection
    <div class="row">
             ...
             <div class="card">
                <div class="card-body">
                    <form action="{{ route('modem_store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_modem">
    ...
    @section('tombol-cetak')
     <a href="{{ route('modem_index') }}" class="btn btn-icon icon-left btn-outline-info btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
