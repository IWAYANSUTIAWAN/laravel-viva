...
<div class="row">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_tv">
    ...
    @section('modal')
        <div class="modal fade " tabindex="-1" role="dialog" id="modal_tv">
