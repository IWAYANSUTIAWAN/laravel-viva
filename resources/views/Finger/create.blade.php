...
@endsection
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('finger_store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="vc" class="form-control" value="{{ old('vc') }}">
                                @if($errors->has('vc'))
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_finger">
