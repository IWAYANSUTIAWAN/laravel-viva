                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            data-tegangan={{ $datas->tegangan }}
                            data-keterangan={{ $datas->keterangan }}
                            >
                            <i class="far fa-clipboard"></i></a> 
                            <a href="{{ route('ups_edit',$datas->id) }}" class="badge badge-warning">Ubah </a>
                            <a href="#" data-id="{{ $datas->id }}" class="badge badge-danger hapus">
                            <form action="{{ route('ups_delete',$datas->id) }}" id="delete{{ $datas->id }}" method="post">
                                @csrf
                                @method('delete')
                            </form>  
                            Hapus </a>
                  ...
                  <table class="table table-bordered ">
                    <tbody>
                       ...
                       <tr class="table-bordered table-active">
                        ...
                        <tr class="table-bordered table-active">
                            <th style="width:25%;">Tegangan</th>
                        <td><span id="Tegangan"></span></td>
                       </tr>
...
@endsection
   @section('tombol-cetak')
    <a href="{{ route('ups_create') }}" class="btn btn-icon btn-sm icon-left btn-primary mr-1"><i class="fas fa-plus"></i> Tambah Data</a>
    <a href="{{ route('ups_cetakpdf') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Pdf</a>
    <a href="{{ route('ups_cetakexcel') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Excel</a>
   @endsection
    ...
    <script>
        $(document).ready(function(){
            $(document).on('click','#detail',function(){
                ...
                var tegangan =$(this).data('tegangan');
