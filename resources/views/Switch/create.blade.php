...
@endsection
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('switch_store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-2">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jumlah Port</label>
                            <div class="col-sm-12 col-md-7">
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_switch">
    ...
    @section('modal')
        <div class="modal fade " tabindex="-1" role="dialog" id="modal_switch">
    ...
    @section('tombol-cetak')
     <a href="{{ route('switch_index') }}" class="btn btn-icon icon-left btn-outline-info btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
