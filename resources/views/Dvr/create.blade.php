...
@endsection
    <div class="row">
             ...
             <div class="card">
                <div class="card-body">
                    <form action="{{ route('dvr_store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_dvr">
                        ...
                        <div class="form-group row mb-2">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Ukuran HD</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="ukuran_hd" class="form-control" value="{{ old('ukuran_hd') }}">
                                @if($errors->has('ukuran_hd'))
                                    <div class="error text-danger">{{ $errors->first('ukuran_hd') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group row mb-2">
 ...
 @section('modal')
    ...
    @section('tombol-cetak')
     <a href="{{ route('dvr_index') }}" class="btn btn-icon icon-left btn-outline-info btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
