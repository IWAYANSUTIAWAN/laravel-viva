                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            data-nama_pengguna={{ $datas->nama_pengguna }}
                            data-os={{ $datas->os }}
                            data-sn_os={{ $datas->sn_os }}
                            data-keterangan={{ $datas->keterangan }}
                            >
                            <i class="far fa-clipboard"></i></a> 
                            <a href="{{ route('cpu_edit',$datas->id) }}" class="badge badge-warning">Ubah </a>
                            <a href="#" data-id="{{ $datas->id }}" class="badge badge-danger hapus">
                            <form action="{{ route('cpu_delete',$datas->id) }}" id="delete{{ $datas->id }}" method="post">
                                @csrf
                                @method('delete')
                            </form>  
                            Hapus </a>
                ...
                <div class="modal-body table-responsive">
                  <table class="table table-bordered ">
                    <tbody>
                       ...
                       <tr class="table-bordered table-active">
                            <th style="width:25%;">Sistem Operasi</th>
                        <td><span id="os"></span></td>
                       </tr>

                       <tr class="table-bordered table-active">
                            <th style="width:25%;">Seria Number OS</th>
...
@endsection
    ...
    <a href="{{ route('cpu_create') }}" class="btn btn-icon btn-sm icon-left btn-primary mr-1"><i class="fas fa-plus"></i> Tambah Data</a>
    <a href="{{ route('cpu_cetakpdf') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Pdf</a>
    <a href="{{ route('cpu_cetakexcel') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Excel</a>
    @endsection
