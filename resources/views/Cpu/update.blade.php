 ...
 <div class="row">
        ...
        <div class="col-12">
           <div class="row">
               ...
               <div class="card-body">
                  <form action="{{ route('cpu_update',$datas->id) }}" method="POST">
                    @csrf
                    @method('patch')
                        ...
                        <div class="form-group row mb-2">
                         ...
                         <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="nama_pengguna" class="form-control" value="{{$datas->nama_pengguna }}">
                                @if($errors->has('nama_pengguna'))
                                    <div class="error text-danger">{{ $errors->first('nama_pengguna') }}</div>
                                @endif
                            </div>
                        </div>
                         <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="os" class="form-control" value="{{$datas->os }}">
                                @if($errors->has('os'))
                         ...
                         <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="sn_os" class="form-control" value="{{$datas->sn_os }}">
                                @if($errors->has('sn_os'))
    ...
    @section('tombol-cetak')
     <a href="{{ route('cpu_index') }}" class="btn btn-icon icon-left btn-outline-info btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
    @endsection
@section('modal')
