...
@endsection
    <div class="row">
             ...
             <div class="card">
                <div class="card-body">
                    <form action="{{ route('telpon_store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="input-group col-sm-10 col-md-7">
                                ...
                                <span class="input-group-button">
                                    <button type="button" class="btn btn-info btn-flat" data-toggle="modal" data-target="#modal_telpon">
                          ...
                          <div class="form-group row mb-2">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Mac Address</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="mac" class="form-control" value="{{ old('mac') }}">
                                @if($errors->has('mac'))
                                    <div class="error text-danger">{{ $errors->first('mac') }}</div>
                                @endif
                            </div>
                        </div>
                          <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-12 col-md-7">
                                ...
                                @if($errors->has('ip'))
                                    <div class="error text-danger">{{ $errors->first('ip') }}</div>
                                @endif
                            </div>
                        </div>
                          <div class="form-group row mb-2">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Ext</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" name="ext" class="form-control" value="{{ old('ext') }}">
                                @if($errors->has('ext'))
                                    <div class="error text-danger">{{ $errors->first('ext') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-group row mb-2">
    ...
    @section('tombol-cetak')
     <a href="{{ route('telpon_index') }}" class="btn btn-icon icon-left btn-outline-info btn-sm"><i class="fas fa-undo-alt"></i> Kembali</a>
