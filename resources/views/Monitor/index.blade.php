                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            data-ukuran={{ $datas->ukuran }}
                            data-keterangan={{ $datas->keterangan }}
                            >
                            <i class="far fa-clipboard"></i></a> 
                            <a href="{{ route('monitor_edit',$datas->id) }}" class="badge badge-warning">Ubah </a>
                            <a href="#" data-id="{{ $datas->id }}" class="badge badge-danger hapus">
                            <form action="{{ route('monitor_delete',$datas->id) }}" id="delete{{ $datas->id }}" method="post">
                                @csrf
                                @method('delete')
                            </form>  
                            Hapus </a>
...
@endsection
   @section('tombol-cetak')
    <a href="{{ route('monitor_create') }}" class="btn btn-icon btn-sm icon-left btn-primary mr-1"><i class="fas fa-plus"></i> Tambah Data</a>
    <a href="{{ route('monitor_cetakpdf') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Pdf</a>
    <a href="{{ route('monitor_cetakexcel') }}" class="btn btn-primary btn-sm mr-1"><i class="fas fa-print"></i> Cetak Excel</a>
   @endsection
